...
(function (e) {
                ...
                if (l)
                    if (Array.isArray(l)) this._expandButton(a, l, c, d);
                        ...
                        j &&
                            ...
                            l.init &&
                                l.init.call(g.button(j.node), g, e(j.node), l),
                            f++);
                    }
            }
        },
            ...
            for (
                var b = this.s.dt,
                    ...
                    g = function (c) {
                        for (
                            var d = 0;
                            !e.isPlainObject(c) && !Array.isArray(c);
        ...
        _popover: function (a, b, c) {
            ...
            e("body")
                .on("click.dtb-collection", function (b) {
                    var c = e.fn.addBack ? "addBack" : "addBack",
    ...
    e.extend(p, {
        ...
        excel: function (a, b) {
            if (p.excelHtml5 && p.excelHtml5.available(a, b))
                return "excelHtml5";
        },
        pdf: function (a, b) {
    ...
    i.Api.register("buttons().containers()", function () {
        ...
        this.iterator(!0, "table", function (c) {
            if (c._buttons)
                for (
                    var c = n.instanceSelector(b, c._buttons),
                        d = 0,
                        e = c.length;
                    d < e;
                    d++
