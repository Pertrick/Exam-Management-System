            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-info">
                        <div class="card-body">
                            <i class="fa fa-user-plus"></i> Edit Student Account - <strong>{{$user->name}} ({{$user->email}})</strong><br><br>

                                    <form id="" action="{{route('admin.student.update',$user)}}" method="post">
                                        @method('put')
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email" class="form-control" id="email"
                                                            placeholder="ex. john@gmail.com" value="{{ $user->email ?? old('email') }}" required>
                                                    </div>
                                                    @error('email')
                                                        <div class="error text-danger text-xs">{{ $message }}</div>
                                                    @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <i>*leave password blank if you're not changing it, otherwise enter updated password!</i>
                                                    </div>
                                                    @error('password')
                                                        <div class="error text-danger text-xs">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="submit" id="save_btn" class="btn bg2 text-white" value="Save" />
                                                    <button type="button" class="btn bg1 text-white">Cancel</button>
                                                </div>
